		...
		<div class="content-main">
			...
			<form id="write_form" action="ctalk_write.do" method="post" enctype="multipart/form-data" class="mt-3 w-80 m-0auto">
				<ul>
					...
					<input type="text" name="ctalk_title" id="ctalk_title" maxlength="50" class="input-check w-90 p-05 ml-auto block-box">
					</li>
					
					<li class="flex-box">
					<label for="ctalk_article"  class="form-ttl">내용</label> 
					<textarea rows="20" cols="40" name="ctalk_article" id="ctalk_article" class="input-check w-90 p-05 ml-auto block-box"></textarea>
					</li>
				</ul>
