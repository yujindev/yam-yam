			...
			<form id="write_form" action="cbob_write.do" method="post" enctype="multipart/form-data">
				<ul>
					<li><label for="cbob_title">제목</label> <input type="text"
						name="cbob_title" id="cbob_title" maxlength="50" class="input-check">
					</li>
					
					<li><label for="cbob_menu">메뉴 선정</label> <input type="text"
						name="cbob_menu" id="cbob_menu" maxlength="50" class="input-check">
					</li>
					...
					<textarea rows="5" cols="40" name="cbob_article" id="cbob_article" class="input-check"></textarea>
					</li>
				</ul>
