...
<body>
	<div class="page-main">
    	...
    	<h2 class="fw-700 fs-16 m-1">잡담 게시판</h2>
    	...
    	<div class="list-space flex-box f-end m-1">
    		...
    		<input type="button" value="글쓰기" onclick="location.href='ctalk_writeForm.do'" class="btn-re btn-line-primary ">
    		</c:if>
    		...
    		<c:if test="${count > 0}">
             ...
             <c:forEach var="ctalk" items="${list}">
                 <li class="mt-2">
                 <a href="ctalk_detail.do?ctalk_num=${ctalk.ctalk_num}">
                     <p class="fs-10 text-main">${ctalk.ctalk_num}</p>
                     <p class="fs-12 fw-700 mt-1">${ctalk.ctalk_title}</p>
                     <p class="fs-08 mt-1">${ctalk.ctalk_date}</p>
                     <p class="fs-08 text-r">조회수 | ${ctalk.ctalk_hit}</p>
