			...
			<div id="reply_div">
				...
				<form id="re_form" class="w-90 flex-box f-between position-r m-0auto">
					<input type="hidden" name="cbob_num" value="${cbob.cbob_num}"
						id="cbob_num">
					<textarea rows="3" cols="50" name="cbob_re_content" id="cbob_re_content" class="rep-content w-80"<c:if test="${empty user_num}"> disabled = "disabled" placeholder="로그인 해야 작성할 수 있습니다."</c:if>></textarea>
