...
<body><div class="page-main">
    	...
    	<h2 class="fw-700 fs-16 m-1">도시락존 게시판</h2>
    	...
    	<div class="list-space flex-box f-end m-1">
    		...
    		<input type="button" value="글쓰기" onclick="location.href='czone_writeForm.do'" class="btn-re btn-line-primary ">
    		</c:if>
    		...
    		<c:if test="${count > 0}">
             ...
             <c:forEach var="czone" items="${list}">
                 <li class="mt-2">
                 <a href="czone_detail.do?czone_num=${czone.czone_num}">
                     <p class="fs-10 text-main">${czone.czone_num}</p>
                     <p class="fs-12 fw-700 mt-1">${czone.czone_title}</p>
                     <p class="fs-08 mt-1">${czone.czone_date}</p>
                     <p class="fs-08 text-r">조회수 | ${czone.czone_hit}</p>
